...
export default function CompleteCategoryManagement() {
  ...
  const deleteCategory = async (categoryId: string) => {
    if (!token || !confirm("Are you sure you want to delete this category? This action cannot be undone.")) return;
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          <h3 className="text-2xl font-bold text-gray-900">Complete Category Management</h3>
          <p className="text-gray-600">Full control over categories, subcategories, icons, and display order</p>
        </div>
        <Button 
